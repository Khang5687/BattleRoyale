...
layout(location = 5) in float inLodTier;    // LOD tier (0=pixel dust, 1=simple, 2=basic texture, 3=full detail)
...
layout(location = 4) out flat uint vLodLevel; // pass LOD level
